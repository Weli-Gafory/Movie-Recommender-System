...
public class Film {
    ...
    public Film(Integer id, String name, String kategorie, String erscheinungsdatum, String regisseur, String drehbuchautor, String cast, String filmlaenge, String filmbanner, int avgBewertung) {
        this(id, name, kategorie, erscheinungsdatum, regisseur, drehbuchautor, cast, filmlaenge, filmbanner);
        this.setAvgBewertung(avgBewertung);
    }
